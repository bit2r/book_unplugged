...
## 컴퓨터와 대화하기  {#turing-intro}

![기계와 대화](img/ch20-turing/20-turing-01-conversation.png){width=100%}
...
## 활동: 튜링 테스트 질문 {#turing-worksheet-question}
...
## 활동: 튜링 테스트 대답 {#turing-worksheet-answer}
...
![로봇](img/ch20-turing/20-turing-02-robot.png){width=100%}
