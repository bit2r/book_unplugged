...
암호화는 정보 보안에 열쇠이다. 현대 암호화의 열쇠는 공개 정보만 사용하여 발시자가 
메시지를 잠그고, 받는 수신자가 메시지를 (물론 개인적으로) 푸는 것이다.  
...
- 기술 레벨 3: 기술 시스템.  
기호 언어 도구를 사용하여 기술 시스템을 표현하는 것을 이해한다. 
기술 시스템에서 블랙박스의 역할을 이해한다.  
...
- 학생은 4명이 한 조가 되는 그룹을 만든다. 각 그룹안에 두개의 소그룹을 만든다. 
각 소그룹에 *키드 크립토 지도* 워크시트 사본지도 두장을 나눠준다. 그래서, 각 그룹 학생들이 필요한 것:
    - *키드 크립토 지도* 사본 2장.  
- 선생님이 필요한 것:  
...
## 언플러그드 동영상  {#public-key-avi}

| 한글 동영상 | 영문 동영상 |
:---------------------------------: | :-------------:|
| `-` | <iframe width="350" height="260" src="https://www.youtube.com/embed/jJrICB_HvuI" frameborder="0" allowfullscreen> </iframe> |


## 키드 크립토  {#public-key-intro}

![키드 크립토(kid crypto)](img/ch18-public-key/18-public-key-01-kid-crypto.png){width=100%}
...
![활동지](img/ch18-public-key/18-public-key-02-kid-worksheet.png){width=100%}
...
![](img/ch18-public-key/18-public-key-03-public-map.png){width=100%}
...
![](img/ch18-public-key/18-public-key-04-intersection.png){width=100%}
...
## 활동: 키드 크립토 지도 {#public-key-worksheet}

![](img/ch18-public-key/18-public-key-05-kid-krypto-map.png){width=100%}


본문에 기술된 지도를 사용해서 메시지를 암호화하고 암호를 푼다.


## 활동: 키드 크립토 인코딩) {#public-key-kid-krypto}

지도를 학급에 보여주고, 메시지를 인코딩하는 것을 시연하는데 다음 그림을 사용하세요.

![](img/ch18-public-key/18-public-key-05-encoding.png){width=100%}


## 컴퓨터 과학 핵심 개념 {#public-key-lesson}
